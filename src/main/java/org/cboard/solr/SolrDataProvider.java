...
public class SolrDataProvider extends DataProvider {
    ...
    @QueryParameter(label = "{{'DATAPROVIDER.SOLR.COLLECTION'|translate}}", pageType = "test,dataset,widget", required = true, type = QueryParameter.Type.Input, order = 1)
    private String collection = "collection";

    @QueryParameter(label = "{{'DATAPROVIDER.SOLR.Q'|translate}}", pageType = "dataset,widget", value = "*:*", placeholder = "*:*|<fieldName>:<fieldValue>[ <AND|OR> <fieldName>:<fieldValue>]...", required = true, type = QueryParameter.Type.TextArea2, order = 2)
    private String q = "q";
    ...
    @QueryParameter(label = "{{'DATAPROVIDER.SOLR.START'|translate}}", pageType = "dataset,widget", value = "0", placeholder = "default value is 0", required = true, type = QueryParameter.Type.Number, order = 5)
    private String start = "start";

    @QueryParameter(label = "{{'DATAPROVIDER.SOLR.ROWS'|translate}}", pageType = "dataset,widget", value = "10", placeholder = "default value is 10", required = true, type = QueryParameter.Type.Number, order = 6)
